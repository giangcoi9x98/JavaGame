...
public class GameController {
    ...
    public GameController() {
        ...
        createEnemy();
        readFile(SettingController.getInstance().getMap());
    }
    ...
    private void readFile(String map) {

         map = SettingController.getInstance().getMap();
         String path = getClass().getResource(map)
                .getPath();
    ...
    public void fireBullet() {
        ...
        if (time - currentTimeFireMyTank > SettingController.getInstance().getPlayerFireRate()) {
            myTank.fireBullet();
    ...
    public void fireEnemyTank() {
        long time = System.currentTimeMillis();
        if (time - currentfireEnemyTank < SettingController.getInstance().getEnemyFireRate()) {
            return;
        }
